...
export function StarsCanvas({
  ...
  useEffect(() => {
    ...
    gradient2.addColorStop(0.1, `hsl(${hue}, 70%, 45%)`); // Brighter ocean blue
    gradient2.addColorStop(0.25, `hsl(${hue}, 80%, 20%)`); // Deep ocean blue
    gradient2.addColorStop(0.5, `hsl(${hue}, 90%, 8%)`); // Very deep blue
    ...
    const animate = () => {
      ...
      ctx.globalAlpha = 0.8;
      ctx.fillStyle = transparent ? 'hsla(217, 90%, 3%, 0)' : 'hsla(217, 90%, 3%, 1)';

      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:2 gap-4">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              `rounded-2xl border-[1px] p-6 bg-black/20 backdrop-blur-sm text-center lg:flex lg:flex-col lg:justify-center relative`,
              plan.isPopular ? "border-blue-400 border-2" : "border-white/10",
              "flex flex-col",
              !plan.isPopular && "mt-5",
              index === 0 || index === 2
          ...
          >
            ...
            <div className="flex-1 flex flex-col">
              <p className="text-base font-semibold text-white/70">{plan.name}</p>
              ...
              <p className="mt-6 text-xs leading-5 text-white/70">{plan.description}</p>
            </div>
          </motion.div>
        ))}
      </div>

...
async function performAnalysis(assetIds: string[], options: any) {
  ...
  return {
    ...
    codeHints: {
      framework: 'react', // or vue, plain based on options
      cssFramework: 'tailwind', // or vanilla, bootstrap
      animations: 'css-transitions', // or gsap, framer-motion

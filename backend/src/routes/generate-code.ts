...
router.get('/:jobId/download', authMiddleware, async (req, res) => {
  try {
    ...
    // In a real implementation, this would create and serve a ZIP file
    res.json({
...
async function generateCodeFromAST(designAST: any, framework: string, options: any) {
  ...
  // Generate JavaScript based on framework
  if (framework === 'react') {
...
// HTML Generator
function generateHTML(title: string = 'Generated Page') {
  return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// CSS Generator
function generateCSS(styles?: any) {
...
function generateJS(framework: string, designAST?: any) {
...
function generateReactComponent(designAST?: any) {
...
function generateVueComponent(designAST?: any) {
  return `<template>
  <section class="hero">
    <div class="hero-content">
      <h1 class="hero-title">AI-Generated Design</h1>
...
// README Generator
function generateReadme(framework: string, designAST?: any) {
...
// Extract assets from AST
function extractAssetsFromAST(children: any[], assets: any[], mapping: any) {
